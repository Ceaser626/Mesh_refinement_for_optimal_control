...
def plot_result(iter_num):
    ...
    plt.grid(ls='--')
    plt.tight_layout()
    plt.savefig(f'Figure/Figure_1.tif')
    ...
    plt.grid(ls='--')
    plt.tight_layout()
    plt.savefig(f'Figure/Figure_2.tif')
    ...
    plt.grid(ls='--')
    plt.tight_layout()
    plt.savefig(f'Figure/Figure_3.tif')
    ...
    plt.grid(ls='--')
    plt.tight_layout()
    plt.savefig(f'Figure/Figure_4.tif')
    ...
    plt.grid(ls='--')
    plt.tight_layout()
    plt.savefig(f'Figure/Figure_5.tif')
    ...
    plt.grid(ls='--')
    plt.tight_layout()
    plt.savefig(f'Figure/Figure_6.tif')
    ...
    plt.grid(ls='--')
    plt.tight_layout()
    plt.savefig(f'Figure/Figure_7.tif')
    plt.show()
